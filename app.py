...
def fetch_poster(movie_id):
    url = 'https://api.themoviedb.org/3/movie/{}?api_key=0d95a44c547874d19c40d99631614246'.format(movie_id)
...
#we can use directly movies.title on select box instead the movies_list
...
if st.button("Show Recommend"):
    recommended_movie, movie_poster = recommend(select_movie)
